...
func Test_hashSha1(t *testing.T) {
	h := hashSha1(strings.NewReader(msg))
...
func Test_hashSha256(t *testing.T) {
	h := hashSha256(strings.NewReader(msg))
...
func Test_hashSha224(t *testing.T) {
	h := hashSha224(strings.NewReader(msg))
...
func Test_hashSha512(t *testing.T) {
	h := hashSha512(strings.NewReader(msg))
...
func Test_hashSha384(t *testing.T) {
	h := hashSha384(strings.NewReader(msg))
...
func Test_hashSha512_224(t *testing.T) {
	h := hashSha512_224(strings.NewReader(msg))
...
func Test_hashSha512_256(t *testing.T) {
	h := hashSha512_256(strings.NewReader(msg))
